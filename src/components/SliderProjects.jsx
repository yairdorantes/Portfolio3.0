          ...
          <SwiperSlide key={i} className="">
            ...
            >
              <div className="absolute  bottom-0 left-0 right-0 px-4 py-2 bg-gray-900 opacity-70">
                ...
                <p className="mt-2 break-words max-h-0 opacity-0 overflow-hidden group-hover:max-h-full group-hover:opacity-100 text-sm text-gray-300 transition-all duration-700">
                  {project.description}
                </p>
